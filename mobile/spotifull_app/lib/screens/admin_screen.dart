          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                _statCard('Active Now', '${admin.activeUserCount}', Icons.person_pin),
                const SizedBox(width: 12),
                _statCard('Pending', '${admin.pendingApprovalCount}', Icons.hourglass_empty),
              ],
            ),
          ),
          Expanded(
                        ...
                        child: Row(
                          children: [
                            CircleAvatar(
                              ...
                              child: u.photoUrl.isEmpty ? Text(u.displayName[0].toUpperCase()) : null,
                            ...
                            if (u.isAdmin)
                              Container(
                                ...
                                child: const Text('Admin', style: TextStyle(color: Color(0xFF10b981), fontSize: 11)),
                              ),
                          ],
                        ),
                      );
